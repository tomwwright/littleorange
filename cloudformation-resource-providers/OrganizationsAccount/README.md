...
1. Write the JSON schema describing your resource, `littleorange-organizations-account.json`
2. Implement your resource handlers in `littleorange_organizations_account/handlers.py`
