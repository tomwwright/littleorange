...
1. Write the JSON schema describing your resource, `littleorange-organizations-organizationalunit.json`
2. Implement your resource handlers in `littleorange_organizations_organizationalunit/handlers.py`
